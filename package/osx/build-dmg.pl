...
my ($dev)  = "/Volumes/$volName"; #FIXME: ($output =~ /(\/dev\/.+?)\s*Apple_partition_scheme/im);
...
#Added by WindPower:
print "> sh ./package/osx/customize-dmg.sh\n";
system("sh", "./package/osx/customize-dmg.sh", "/Volumes/$volName");
