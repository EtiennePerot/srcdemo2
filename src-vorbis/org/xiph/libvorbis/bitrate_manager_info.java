...
{ // detailed bitrate management setup
	...
	/*
	 * float queue_avg_time; float queue_avg_center; float queue_minmax_time; float queue_hardmin; float queue_hardmax; float
	 * queue_avgmin; float queue_avgmax; float avgfloat_downslew_max; float avgfloat_upslew_max;
	 */
	public bitrate_manager_info()
	{
	}

	public bitrate_manager_info(int _avg_rate, int _min_rate, int _max_rate, int _reservoir_bits, float _reservoir_bias,
			float _slew_damp)
	{
		avg_rate = _avg_rate;
		min_rate = _min_rate;
