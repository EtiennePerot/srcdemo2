...
public class vorbis_info_mapping0
{
	...
	public vorbis_info_mapping0(int _submaps, int[] _chmuxlist, int[] _floorsubmap, int[] _residuesubmap, int _coupling_steps,
	...
	{
		this(src.submaps, src.chmuxlist, src.floorsubmap, src.residuesubmap, src.coupling_steps, src.coupling_mag,
				src.coupling_ang);
	}
}