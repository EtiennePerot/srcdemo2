...
public interface DokanOperations
{
	...
	/**
	 * If file is a directory, CreateFile (not OpenDirectory) may be called. In this case, CreateFile should return 0 when that
	 * directory can be opened. You should set TRUE on DokanFileInfo->IsDirectory when file is a directory. When
	 * CreationDisposition is CREATE_ALWAYS or OPEN_ALWAYS and a file already exists, you should return
	...
	/**
	 * Neither GetDiskFreeSpace nor GetVolumeInformation save the DokanFileContext->Context. Before these methods are called,
	 * CreateFile may not be called. (ditto CloseFile and Cleanup)
	 * 
	 * @param fileInfo
	 * @return
	 * @throws DokanOperationException
